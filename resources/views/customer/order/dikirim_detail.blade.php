            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-12 col-lg-12 card" style="background:white;">
                    ...
                    <tbody>
                        ...
                        </tr> <tr style="padding:0px 0px 0px 0px;">
                            <td colspan="4"class="text-center">
                            <form method="POST" action="{{route('ui.diterima')}}">
                                @csrf
                            <input type="hidden" name="id_order" value="{{$id}}">
                            <button type="submit" style="background:#006db2; color: white; border-radius: 10px 10px 10px 10px; width:300px; padding: 10px 10px 10px 10px;"> BARANG DITERIMA </button>
                            </form>
                            </td>
                        </tr>
                    </tbody>
