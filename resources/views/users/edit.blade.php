                                ...
                                <form method="POST" action="{{ route('users.update',$user->id) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" placeholder="85863046869" value="{{ substr($user->phone,3) }}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                        </div>
                                        @error('phone')
                                            <div class="text-danger small mt-1">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" value="{{ old('alamat') }}"  placeholder="Alamat">{{ $user->alamat }}</textarea> 
                                        @error('alamat')
                                            <div class="text-danger small mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
